    ...
    <div className='w-screen h-screen bg-green-600 flex items-center justify-center'>
      <div className='bg-white p-5 w-[340px] rounded-2xl shadow-2xl'>
        ...
        <div className='flex justify-between items-center mt-6'>
            ...
            <input placeholder='user@gmail.com' className='cursor-pointer border-2 border-black border-solid rounded-md' id='username' type="text" value={email} onChange={(el) => {setEmail(el.target.value)}} />
        </div>
